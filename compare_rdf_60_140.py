...
Expected structure:
    ...
    ├── rdf_analysis.py
    └── results/
        ├── Long_sim_60/my_simulation_pos.xyz
        ├── Long_sim_80/my_simulation_pos.xyz
        ├── Long_sim_100/my_simulation_pos.xyz
        ├── Long_sim_120/my_simulation_pos.xyz
        └── Long_sim_140/my_simulation_pos.xyz
"""
...
DATASETS = [
    {
        "label": "Simulation at 60 K",
        "xyz_path": RESULTS_DIR / "Long_sim_60" / "my_simulation_pos.xyz",
        "box_length_nm": 6.0,
        "start_frame": 4000,
        "stop_frame": None,
        "frame_stride": 20,
    ...
    },
    {
        ...
        "xyz_path": RESULTS_DIR / "Long_sim_80" / "my_simulation_pos.xyz",
        "box_length_nm": 6.0,
        "start_frame": 4000,
        "stop_frame": None,
        "frame_stride": 20,
    ...
    {
        "label": "Simulation at 100 K",
        "xyz_path": RESULTS_DIR / "Long_sim_100" / "my_simulation_pos.xyz",
        "box_length_nm": 6.0,
        "start_frame": 4000,
        "stop_frame": None,
        "frame_stride": 20,
    ...
    {
        "label": "Simulation at 120 K",
        "xyz_path": RESULTS_DIR / "Long_sim_120" / "my_simulation_pos.xyz",
        "box_length_nm": 6.0,
        "start_frame": 4000,
        "stop_frame": None,
        "frame_stride": 20,
    ...
    {
        "label": "Simulation at 140 K",
        "xyz_path": RESULTS_DIR / "Long_sim_140" / "my_simulation_pos.xyz",
        "box_length_nm": 6.0,
        "start_frame": 4000,
        "stop_frame": None,
        "frame_stride": 20,
...
COMBINED_PLOT_PATH = PROJECT_DIR / "rdf_comparison_60K_to_140K.png"

SAVE_INDIVIDUAL_CSV_FILES = True
CSV_OUTPUT_DIR = PROJECT_DIR / "rdf_comparison_data_60K_to_140K"
...
def main():
    ...
    ax.set_title(
        "Comparison of Radial Distribution Functions from 60 K to 140 K",
        pad=15,
    )
